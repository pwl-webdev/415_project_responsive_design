...
function qb(a){a&&("string"==typeof a&&(a=[a]),y(a,function(a){if(a in A){var c=A[a],d=c[0],e=c[1],f=c[3],c=c[4];d.removeEventListener?d.removeEventListener(e,f,c):d.detachEvent&&d.detachEvent("on"+e,f);delete A[a]}}))}
...
return this})},a)}
g.V=function(){var a=O(this.b,"host")+this.o(),b='<iframe width="'+O(this.b,"width")+'" height="'+O(this.b,"height")+'" src="';na.test(a)&&(-1!=a.indexOf("&")&&(a=a.replace(ha,"&amp;")),-1!=a.indexOf("<")&&(a=a.replace(ia,"&lt;")),-1!=a.indexOf(">")&&(a=a.replace(ja,"&gt;")),-1!=a.indexOf('"')&&(a=a.replace(ka,"&quot;")),-1!=a.indexOf("'")&&(a=a.replace(la,"&#39;")),-1!=a.indexOf("\x00")&&(a=a.replace(ma,"&#0;")));return b+a+'" frameborder="0" allowfullscreen></iframe>'};
